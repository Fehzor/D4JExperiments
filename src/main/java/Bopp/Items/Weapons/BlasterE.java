 ...
 * @author FF6EB4
 */
public class BlasterE extends Gear {
    int num, rate;
    public BlasterE(String name, String prereq,int stars, int chance, int rate){
        super(name,prereq,"",stars);
        this.name = name;
        this.stars = stars;

        super.description = "+"+chance+"% chance to give away an orb! Get "+rate+"x crowns from drops!";
        this.slot = WEAPON;
