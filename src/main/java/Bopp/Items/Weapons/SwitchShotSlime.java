 ...
 * @author FF6EB4
 */
public class SwitchShotSlime extends Gear{
   public SwitchShotSlime(String name, String prereq,int stars){
        super(name,prereq,"",stars);
        this.name = name;
        this.stars = stars;

        super.description = "+"+(stars)*10+"% chance of 7 slime coins; Switches other weapons out randomly!";
        this.slot = WEAPON;
    ...
    public void effect(UserData UD, Gate G){
        if(oRan.nextInt(100) < stars*10){
            UD.slimeCoins.data+=7;
        }
