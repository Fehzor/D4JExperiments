 ...
 * @author FF6EB4
 */
public class CauteryDeposit extends Gear{
    public CauteryDeposit(String name, String prereq,int stars, int mat2){
        super(name,prereq,"",stars);
        this.name = name;
        this.stars = stars;

        super.description = "+Generate+Autodeposit 40 random minerals!";
        this.slot = WEAPON;
    ...
    public void effect(UserData UD, Gate G){
        int min = oRan.nextInt(5);
        G.minerals.data[min] += 40;
    }
}
