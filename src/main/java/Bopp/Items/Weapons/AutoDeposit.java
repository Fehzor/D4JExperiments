 ...
 * @author FF6EB4
 */
public class AutoDeposit extends Gear{
    int mins;
    public AutoDeposit(String name, String prereq,int stars, String Col, int min, int mat2){
        super(name,prereq,"",stars);
        this.name = name;
        this.stars = stars;

        super.description = "+Generate+autodeposit "+stars*6+ " "+Col+" minerals!";
        this.slot = WEAPON;
