 ...
 * @author FF6EB4
 */
public class ShardBomb extends Gear{
    int amt;
    int color;
    public ShardBomb(String name, String prereq, int amt, int color, int mat1){
        ...
        if(color == 2)col = "blue";
        if(color == 3)col = "yellow";
        if(color == 4)col = "purple";
        
        super.description = "+"+amt*3+" "+col+" minerals per message!";
        this.slot = WEAPON;
