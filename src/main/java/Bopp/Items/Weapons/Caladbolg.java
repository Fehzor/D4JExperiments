 ...
 * @author FF6EB4
 */
public class Caladbolg extends Gear{
    public Caladbolg(String name, String prereq,int stars){
        super(name,prereq,"",stars);
        this.name = name;
        this.stars = stars;

        super.description = "+Generate+Autodeposit 10 of each mineral each message!";
        this.slot = WEAPON;
