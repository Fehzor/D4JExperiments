 ...
 * @author FF6EB4
 */
public class PoisonAutogun extends Gear{
        int odds;
    public PoisonAutogun(String name, String prereq,int stars, int chance){
        super(name,prereq,"",stars);
        this.name = name;
        this.stars = stars;

        super.description = "+"+chance+"% chance of more crowns for all!";
        this.slot = WEAPON;
