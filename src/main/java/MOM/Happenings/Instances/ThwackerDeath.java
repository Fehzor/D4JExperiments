 ...
 * @author FF6EB4
 */
public class ThwackerDeath extends Happening{
    public ThwackerDeath(){
        super();
        this.flavorText = "An avalanche of falling debris has crushed several of your thwackers.. "
                + "(+corpses, -thwackers)";
    }
    
    public boolean check(UserData UD){
        return UD.thwackers.getData() > 30;
    }
    ...
    public boolean actUpon(UserData UD){
        if(super.actUpon(UD)){
            ...
            UD.thwackers.writeData(UD.thwackers.getData() - num);
